              ...
              child: Row(
                children: [
                  InkWell(
                    ...
                    child: Container(width: 50, color: Colors.black54, child: Center(child: Text("-",style: new TextStyle(fontWeight: FontWeight.w600, fontSize: 25.0, color: Colors.white)))),
                  ),
                  Container(width: 50, color: Colors.black54, child: Center(child: Text('$itemcount',style: new TextStyle(fontWeight: FontWeight.w500, fontSize: 25.0, color: Colors.white)))),
                  InkWell(
                    onTap: ((){
                      setState(() {
